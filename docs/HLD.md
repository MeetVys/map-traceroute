...
| **Browser UI** | Renders the world map (arcs colored by protocol, height by direction) **and a live packet list** below it, both driven by the same packet stream. Start / Stop buttons. Three switchable themes (Console / Space / Paper). |
